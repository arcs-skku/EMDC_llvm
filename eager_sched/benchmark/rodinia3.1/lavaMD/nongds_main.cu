		...
		char *argv [])
{
	...
	int fd = -1;
	ssize_t ret = -1;
	size_t test_offset = 2147479552 / 32;

	if(dim_cpu.boxes1d_arg == 100){
		printf("Large1\n");
		fd = open("large1/box_large1.txt", O_RDONLY, 0644);
		printf("%d\n", fd);

		int cnt = 0;
		size_t alloc_size = dim_cpu.box_mem;
		int quo;
		size_t rem;
		...
		while(1){
			...
			printf("quo: %d\n", quo);
			if(quo > 0){
				ret = read(fd, box_cpu+(cnt*test_offset), 2147479552);
				printf("%zd\n", ret);
				cnt++;
				...
				ret = read(fd, box_cpu+(cnt*test_offset), rem);
				printf("%zd\n", ret);
				break;
			}
		}
		...
		fd = open("large1/rv_large1.txt", O_RDONLY, 0644);
		printf("%d\n", fd);

		cnt = 0;
		alloc_size = dim_cpu.space_mem;

		while(1){
			quo = alloc_size / 2147479552;
			printf("quo: %d\n", quo);
			if(quo > 0){
				ret = read(fd, rv_cpu+(cnt*test_offset), 2147479552);
				printf("%zd\n", ret);
				cnt++;
				alloc_size -= 2147479552;
				if (ret == -1) { 
				...
				rem = alloc_size % 2147479552;
				ret = read(fd, rv_cpu+(cnt*test_offset), rem);
				printf("%zd\n", ret);
				break;
			}
		}
		...
		fd = open("large1/qv_large1.txt", O_RDONLY, 0644);
		printf("%d\n", fd);

		cnt = 0;
		alloc_size = dim_cpu.space_mem2;

		while(1){
			quo = alloc_size / 2147479552;
			printf("quo: %d\n", quo);
			if(quo > 0){
				ret = read(fd, qv_cpu+(cnt*test_offset), 2147479552);
				printf("%zd\n", ret);
				cnt++;
				alloc_size -= 2147479552;
				if (ret == -1) { 
				...
				rem = alloc_size % 2147479552;
				ret = read(fd, qv_cpu+(cnt*test_offset), rem);
				printf("%zd\n", ret);
				break;
			}
		}
		...
		fd = open("large1/fv_large1.txt", O_RDONLY, 0644);
		printf("%d\n", fd);
		...
		while(1){
			...
			printf("quo: %d\n", quo);
			if(quo > 0){
				ret = read(fd, fv_cpu+(cnt*test_offset), 2147479552);
				printf("%zd\n", ret);
				cnt++;
				alloc_size -= 2147479552;
				if (ret == -1) { 
				...
				rem = alloc_size % 2147479552;
				ret = read(fd, fv_cpu+(cnt*test_offset), rem);
				printf("%zd\n", ret);
				break;
			}
		}
		...
		printf("Large2\n");
		fd = open("large2/box_large2.txt", O_RDONLY, 0644);
		printf("%d\n", fd);
		...
		fd = open("large2/rv_large2.txt", O_RDONLY, 0644);
		printf("%d\n", fd);
		...
		fd = open("large2/qv_large2.txt", O_RDONLY, 0644);
		printf("%d\n", fd);
		...
		fd = open("large2/fv_large2.txt", O_RDONLY, 0644);
		printf("%d\n", fd);
		...
		printf("Large3\n");
		fd = open("large3/box_large3.txt", O_RDONLY, 0644);
		printf("%d\n", fd);
		...
		fd = open("large3/rv_large3.txt", O_RDONLY, 0644);
		printf("%d\n", fd);
		...
		fd = open("large3/qv_large3.txt", O_RDONLY, 0644);
		printf("%d\n", fd);
		...
		fd = open("large3/fv_large3.txt", O_RDONLY, 0644);
		printf("%d\n", fd);
	...
	std::cout << "Host preprocessing time: " << duration.count() << std::endl;
	...
	FOUR_VECTOR* out_fv_cpu;
	out_fv_cpu = (FOUR_VECTOR*)malloc(dim_cpu.space_mem);

	// CUDA_CHECK(cudaMemcpy(out_fv_cpu, ret4.devPtr, ret4.alloc_size, cudaMemcpyDeviceToHost));
	// CUDA_CHECK(cudaMemcpy(out_fv_cpu, fv_cpu, dim_cpu.space_mem, cudaMemcpyDeviceToHost));
	CUDA_CHECK(cudaMemPrefetchAsync(ret4.devPtr, ret4.alloc_size, cudaCpuDeviceId, 0))
	// CUDA_CHECK(cudaDeviceSynchronize());
	...
	char* str1 = argv[3];
		...
		int cnt = 0;
		size_t alloc_size = dim_cpu.space_mem;
		int quo;
		size_t rem;
		ssize_t o_ret = -1;
		...
		while(1){
			...
			printf("quo: %d\n", quo);
			if(quo > 0){
				o_ret = write(o_fd, fv_cpu+(cnt*test_offset), 2147479552);
				printf("%zd\n", o_ret);
				cnt++;
				alloc_size -= 2147479552;
				if (o_ret == -1) { 
				...
				rem = alloc_size % 2147479552;
				o_ret = write(o_fd, fv_cpu+(cnt*test_offset), rem);
				printf("%zd\n", o_ret);
				break;
			}
		}
